...
export async function buildApp() {
  ...
  const nuitkaArgs = [
    path.join(SCRIPT_DIR, 'proxyCheckerGui.py'),
    '--output-file=proxyCheckerGui.exe',
    '--report=build/nuitka-proxyCheckerGui-report.xml',
    '--output-dir=build',
    `--windows-icon-from-ico=${ICON}`,
    `--windows-company-name=${COMPANY_NAME}`,
    '--windows-product-name=proxyCheckerGui',
