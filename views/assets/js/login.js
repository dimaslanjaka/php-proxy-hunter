...
// Send data to /php_backend/google-oauth.php
...
if (codeParam) {
  ...
  $.post('/php_backend/google-oauth.php', { 'google-oauth-callback': codeParam }, function (response) {
    if (response.success) {
...
$.get(`/php_backend/google-oauth.php?google-auth-uri=${new Date().toISOString()}`, function (response) {
