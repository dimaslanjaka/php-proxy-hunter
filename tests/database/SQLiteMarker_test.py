...
def test_mark_without_expiry_is_always_valid(marker: SQLiteMarker) -> None:
    ...
    pending, already_checked = marker.filter_unseen(
...
def test_future_expiry_is_respected_with_as_of(marker: SQLiteMarker) -> None:
    ...
    pending_before, checked_before = marker.filter_unseen(
        ["4.4.4.4:3128"],
        as_of="2026-01-01T00:00:00Z",
    )
    ...
    pending_after, checked_after = marker.filter_unseen(
        ["4.4.4.4:3128"],
...
def test_mark_supports_days_from_now(marker: SQLiteMarker) -> None:
    ...
    pending_now, checked_now = marker.filter_unseen(
        ["6.6.6.6:8080"],
    ...
    pending_later, checked_later = marker.filter_unseen(
        ["6.6.6.6:8080"],
