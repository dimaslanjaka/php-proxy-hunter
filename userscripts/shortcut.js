...
(() => {
	...
	ul.setAttribute(
		"style",
		"color: white;margin:0px;padding:0px;list-style-type: none;"
	);
	...
	closeBtn.setAttribute(
		"style",
		"color: white;background-color: black;margin:3px;padding:0px;"
	);
	closeBtn.innerHTML = "X";
	const remover = () => {
		if (document.getElementById("floatMyWidgetTool"))
