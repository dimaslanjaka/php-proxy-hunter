  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-5xl bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 md:p-12 flex flex-col gap-10 border border-gray-200 dark:border-gray-700">
          <div className="flex flex-wrap gap-8 justify-center">
            {/* User Saldo Widget */}
            <div className="flex-1 min-w-[260px] max-w-xs bg-yellow-50 dark:bg-yellow-900/60 rounded-2xl p-8 flex flex-col items-center shadow-md border border-yellow-200 dark:border-yellow-800">
              <span className="fa-solid fa-wallet text-yellow-600 dark:text-yellow-300 text-4xl mb-4"></span>
              <div className="text-lg font-semibold text-yellow-700 dark:text-yellow-200 mb-1">
                {t('point', 'Point')}
              </div>
            ...
            <div className="flex-1 min-w-[260px] max-w-xs bg-gray-100 dark:bg-gray-700/70 rounded-2xl p-8 flex flex-col items-center shadow-md border border-gray-200 dark:border-gray-700 opacity-80 cursor-not-allowed">
